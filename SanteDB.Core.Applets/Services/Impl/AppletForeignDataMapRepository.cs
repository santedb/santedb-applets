...
namespace SanteDB.Core.Applets.Services.Impl
{
    ...
    public class AppletForeignDataMapRepository : IRepositoryService<ForeignDataMap>
    {
        ...
        /// Applet foreign data map repository
        /// </summary>
        public AppletForeignDataMapRepository(IAppletManagerService appletManagerService, IConfigurationManager configurationManager, IAppletSolutionManagerService appletSolutionManagerService = null)
        {
