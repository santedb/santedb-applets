...
namespace SanteDB.Core.Applets.Test
{
    ...
    public class ViewModelSerializerTest
    {
        ...
        //{
        //	using (var sr = new StreamReader(typeof(TestRenderApplets).Assembly.GetManifestResourceStream("SanteDB.Core.Applets.Test.DoesntSerializeKey.json")))
        //	{
        ...
        //{
        //	using (var sr = new StreamReader(typeof(TestRenderApplets).Assembly.GetManifestResourceStream("SanteDB.Core.Applets.Test.SimpleModel.json")))
        //	{
        //		var json = sr.ReadToEnd();
        //		var patient = JsonViewModelSerializer.DeSerialize<Patient>(json);
        ...
        //{
        //	using (var sr = new StreamReader(typeof(TestRenderApplets).Assembly.GetManifestResourceStream("SanteDB.Core.Applets.Test.SimpleBundle.json")))
        //	{
        //		var json = sr.ReadToEnd();
        ...
        //{
        //	using (var sr = new StreamReader(typeof(TestRenderApplets).Assembly.GetManifestResourceStream("SanteDB.Core.Applets.Test.RegistrationForm.json")))
        //	{
        //		var json = sr.ReadToEnd();
        //		var patient = JsonViewModelSerializer.DeSerialize<Patient>(json);
        ...
        //{
        //	using (var sr = new StreamReader(typeof(TestRenderApplets).Assembly.GetManifestResourceStream("SanteDB.Core.Applets.Test.QuantityObservation.json")))
        //	{
        //		var json = sr.ReadToEnd();
        ...
        public void TestSerializeActWithDeepNestDefinition()
        {
            ...
            ViewModelDescription vmd = ViewModelDescription.Load(typeof(ViewModelSerializerTest).Assembly.GetManifestResourceStream("SanteDB.Core.Applets.Test.DeepActModel.xml"));
            var serializer = new JsonViewModelSerializer();
            serializer.ViewModel = vmd;
            var actual = serializer.Serialize(act);
        ...
        public void TestShouldNotRecurse()
        {
            ...
            patient.Relationships = new List<EntityRelationship>() {
        ...
        //{
        //	using (var sr = new StreamReader(typeof(TestRenderApplets).Assembly.GetManifestResourceStream("SanteDB.Core.Applets.Test.DoesntInterpretSimpleArray.json")))
        //	{
        //		var json = sr.ReadToEnd();
